      ...
      try {
         ...
         switch (command) {
            case 'menu':
			   ...
			   const mancagambar = 'https://raw.githubusercontent.com/setyawan12/gambarmboh/master/gambarmanca.jpg'
			   mancagambar2 = await getBuffer(mancagambar);
               const Menu = {
...
♡ۣۜۜ፝͜͜͡͡✿➤ KALO GA ADA DI MENU JANGAN KETIK!`,
           ...
           case 'galaxstyle':
            ...
            case 'metallogo':
               ...
               nuy.sendMessage(from, metal, image, { quoted: mek });
               await limitAdd(sender);
               break;
            case 'bpink':
               if (isBanned) return reply(mess.only.benned);
               ...
               nuy.sendMessage(from, black, image, { quoted: mek });
               await limitAdd(sender);
               break;
            case 'addprem':
               nuy.updatePresence(from, Presence.composing);
